"""
Canonical Festival Bloomberg warehouse repository interface.

This is the single read/write contract for the Festival Bloomberg warehouse,
consolidating functionality from the intelligence codebase.
