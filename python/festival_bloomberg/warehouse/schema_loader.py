...
# Get the project root by going up from the warehouse directory (python/festival_bloomberg/warehouse -> project root)
# File path: .../festival-bloomberg/python/festival_bloomberg/warehouse/schema_loader.py
# We need to go up 4 levels to get to project root
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
# Use absolute path to schema file
SCHEMA_PATH = os.path.abspath(os.path.join(PROJECT_ROOT, "schema", "duckdb.sql"))
