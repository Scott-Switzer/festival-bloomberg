...
-- Check if the old table exists and has the old schema structure (has tier_key instead of id)
-- Note: DuckDB doesn't support DO $$ blocks, so we use a simpler approach

-- Drop any existing table to ensure canonical schema
