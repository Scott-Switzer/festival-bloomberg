...
**Branch:** `feat/cloud-data-plane-v1` (post-#46)
...
|---|---|---|---|
| `boxoffice_research_v2.duckdb` | 5.0 GB | `08ac97d0244ed4d...` | SHA256_STREAM_VERIFIED ✅ |
| `artist_market_event_history.duckdb` | 39 MB | `0c5b71f09906c66...` | UPLOADED |
| `festival_bloomberg.duckdb` | 16 MB | `3cd71d003555f78...` | SHA256_ROUND_TRIP + DUCKDB_OPEN ✅ |
...
| `ticket_market.duckdb` | 36 MB | `52eb5b85bccdce7...` | SHA256_ROUND_TRIP + DUCKDB_OPEN ✅ |
...
| **CLOUD_RECOVERY_FROM_EMPTY_DATA_DIR** | ✅ **PASS** |
| 5GB SHA256 stream-hash | ✅ `rclone cat | shasum` matches manifest |
| R2ObjectStore put/get/dedup | ✅ All tests pass |
| R2ObjectStore zstd compression | ✅ Working |
| Config namespace regression | ✅ `config.py` + `cloud/` coexist |
...
| `python/festival_bloomberg/cloud/r2_storage.py` | R2 configuration and cutover contract |
| `tests/python/test_cloud_imports.py` | Regression: config + cloud imports coexist |
